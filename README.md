...
A dark Cyberpunk Theme for Columns UI Foobar2000 for 32 or 64 bit. Focused on a clean dynamic look with switchable tabs while utilizing several community components and scripts. 
...
_Note: I wasnt sure where I downloaded playcount sync but I am pretty sure it was the link above but it is now removed, use the component in the repo folder (foobar components) for the download_
